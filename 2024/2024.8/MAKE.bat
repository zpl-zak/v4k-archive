...
if "%1"=="fwk" (
    ...
    copy/y ..\fwk-mirror\engine\art\fx\* _fwk\engine\art\fx\
    copy/y ..\fwk-mirror\demos\art\fx\* _fwk\demos\art\fx\
...
if "%1"=="fwk_prep" (
    ...
    if not exist "_fwk\demos\art" mkdir "_fwk\demos\art"
    if not exist "_fwk\demos\art\fx" mkdir "_fwk\demos\art\fx"
    ...
    if not exist "_fwk\engine\art\fx" mkdir "_fwk\engine\art\fx"
    ...
    xcopy /y "engine\art\fx\*" "_fwk\engine\art\fx"
    xcopy /y "demos" "_fwk\demos"
    xcopy /y "demos\art\fx" "_fwk\demos\art\fx"
